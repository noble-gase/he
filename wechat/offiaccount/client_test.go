...
func Test_OA_VerifyEventMsg(t *testing.T) {
	c := NewClient("wxba5fad812f8e6fb9", "secret")
	c.SetServerConfig("AAAAA", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")

	err := c.VerifyEventMsg("046e02f8204d34f8ba5fa3b1db94908f3df2e9b3", "1714112445", "415670741", "")
	assert.Nil(t, err)
}
...
func Test_OA_DecodeEventMsg(t *testing.T) {
	...
	b, err := c.DecodeEventMsg("")
	assert.Nil(t, err)
